...
public class FingerprintActivity extends BRActivity {
    ...
    private String getLimitText() {
        ...
        BigDecimal amount = BRExchange.getAmountFromSatoshis(this, "PTC", satoshis);
        ...
        return String.format(getString(R.string.TouchIdSettings_spendingLimit), BRCurrency.getFormattedCurrencyString(this, "PTC", amount), BRCurrency.getFormattedCurrencyString(this, iso, curAmount));
    }
